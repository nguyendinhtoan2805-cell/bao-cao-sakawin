...
function editable(team,input,roster,metadata) {
  const allow=team==='shoots'?['title','start','end','location','hosts','crew','notes']
    :['title','deadline','hours','assignees','importantFinal',...(team==='media'?['month','brief','scriptLink','channels','notes','result','resultFacebook','importantScript']:['style','color','size','format','quantity','result','priority'])];
  const out={};
