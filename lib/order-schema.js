...
const schemas = {
  ...
  media: {
    ...
    ...common,
    shoot: ['Buổi quay', 18], writers: ['Người viết', 11],
    script: ['Kịch bản trên web', 1], importantScript: ['Cần duyệt kịch bản', 7],
    scriptReview: ['Duyệt kịch bản', 1],
  },
  shoots: {
...
const workflowKeys = {
  ...
  media: [...Object.keys(common), 'shoot', 'writers', 'script', 'importantScript', 'scriptReview'],
...
module.exports = {schemas, workflowKeys, stages, scriptParts, text, people, decode, missing};
